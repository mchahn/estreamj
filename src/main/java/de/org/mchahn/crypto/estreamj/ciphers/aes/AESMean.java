...
/**
 * fast AES implementation; based on the work of Brian Gladman's optimizations
 * and C code, and the Bouncy Castle translation to Java; minor improvements
 * have been made to pump up the speed (plus sharing lots of common code in AES)
 */
